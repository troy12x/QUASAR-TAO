...
def build_full_context(
    ...
    context_parts.append("")
    context_parts.append("🔴 MANDATORY IMPORTS (VALIDATOR WILL REJECT WITHOUT THESE):")
    context_parts.append("You MUST include these exact imports in chunk.py:")
    context_parts.append("  from fla.utils import autocast_custom_bwd")
    context_parts.append("  from fla.utils import autocast_custom_fwd")
    context_parts.append("  from fla.utils import autotune_cache_kwargs")
    context_parts.append("  from fla.utils import check_shared_mem")
    context_parts.append("  from fla.utils import input_guard")
    context_parts.append("⚠️  Missing any of these imports will cause validation to fail with score 0.0")
    context_parts.append("")
    if byoc_mode and byoc_file_path:
        ...
        context_parts.append("   → Ensure expert code includes all MANDATORY IMPORTS above")
        context_parts.append("")
    context_parts.append("")
